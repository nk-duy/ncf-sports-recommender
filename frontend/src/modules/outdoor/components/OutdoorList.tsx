...
import { CATEGORY_OUTDOOR_MOCK } from "../data/mockOutdoor";
    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-white rounded-2xl border border-gray-100 p-4 shadow-sm mb-6 gap-4">
        <div className="text-sm text-gray-600">
          Hiển thị <span className="font-bold text-gray-900">8</span> trong số <span className="font-bold text-gray-900">146</span> dụng cụ dã ngoại ngoài trời
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 mb-10">
        {CATEGORY_OUTDOOR_MOCK.map((product) => (
